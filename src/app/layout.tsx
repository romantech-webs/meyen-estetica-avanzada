  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="meyen-estetica-avanzada";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Meyen Estética Avanzada"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="meyen-estetica-avanzada"
          data-primary-color="#C9A86C"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="meyen-estetica-avanzada";
